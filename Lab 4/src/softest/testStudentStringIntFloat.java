...
public class testStudentStringIntFloat {
	...
	assertEquals(true, s1.Comparison(s1, s2));     //works
	/* for direct comparison */
	//assertEquals(s1.get_marks(), s2.get_marks(), 0.001);  // Does not work . Gives error
	}
